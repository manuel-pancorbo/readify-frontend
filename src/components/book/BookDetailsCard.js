...
const useStyles = makeStyles((theme) => ({
    paper: {
        ...
        width: theme.spacing(7), height: theme.spacing(7), marginRight: "10px", color: theme.palette.getContrastText(theme.palette.secondary.main), backgroundColor: theme.palette.secondary.main
    }, title: {
                    ...
                    <Grid item>
                        ...
                        <Grid container direction={"row"} alignItems={"center"}>
                            ...
                            <Grid item className={classes.bookStatusContainer}>
                                <Chip className={classes.bookStatus} label={mapStatus(book.status)}></Chip>
                            </Grid>
                            <Grid item>
